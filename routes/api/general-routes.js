...
// Description: This file offers a set of general purpose routes in the application
///////////////////////////////////////////////////////////////////////////////////////////////////
...
module.exports = router => {
  ///////////////////////////////////
  // Functions for scraping sites
  ///////////////////////////////////
  // scrape content from Smashing Magazine
  const scrapeSmashingMagazineSite = cb_loadScrapedData => {
    try {
      ...
      request("https://www.smashingmagazine.com/articles/", function(
        error,
        response,
        html
      ) {
        if (error) {
          return console.error(
            "Scrape from Smashing Magazine site failed: ",
            error
          );
        }
  ...
  // load articles that have been scraped
  const loadScrapedData = (err, articleList) => {
  ...
  // @desc    Scrape data route to retrieve articles
  // @access  Private
  //////////////////////////////////////////////////////
  router.get(
    "/api/scrape",
    ...
    (req, res) => {
      ...
      console.log(
        "after scrape of data but just before redirect to get from the store."
      );
  ...
  // @desc    Clear all articles that are stored in MongoDB
  // @access  Private
  /////////////////////////////////////////////////////////////
  router.get(
    "/api/articles/clear",
